...
namespace GoM.Feeds.Abstractions
{
    public interface IFeedReader: IDisposable
    {
        ...
        /// <returns>A <see cref="Task{ReadPackagesResult}"/> of all the instances getting retreived from the web</returns>
        ...
        /// <returns>A <see cref=" Task{ReadDependenciesResult}"/> of all the instances getting retreived from the web</returns>
        ...
        /// <returns> the pending <see cref="Task{FeedMatchResult}"/> of the return</returns>
